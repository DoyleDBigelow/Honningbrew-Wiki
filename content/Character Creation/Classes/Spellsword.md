...
Weapons: All simple weapons, one martial weapon of your choice.
...
- (a) a component pouch or (b) enchanted staff of a selected cantrip
...
|   |   |   |   |   |   |   |   |
|---|---|---|---|---|---|---|---|
|Level|Proficiency<br><br>Bonus|Arcane Blade|Features|Cantrips Known|Spells Known|Spell Slots|Slot Level|
...
- Cantrips. At 1st level you know two cantrips of your choice. You learn additional cantrips of your choice at higher levels as shown in the Cantrips Known column on the Spellsword table above.
    

- Spell Slots. The Spellsword table shows how many spell slots you have. The table also shows what the level of those slots is; all of your spell slots are the same level. To cast one of the spells of 1st level or higher, you must expend a spell slot. You regain all expended spell slots when you finish a short rest or long rest.
...
At 2nd level a Blademaster gains the ability to use Action Surge and Second Wind.
...
Beginning at 11th level, a Blademaster may add 3d8 of their weapon's element at the time to damage. The Blademaster must expend a spell slot to do so.

Beginning at 14th level, a Blademaster gains an additional attack when you do the attack action.
...
Beginning at 2nd level, the Magister has one more spell slot.

Beginning at 6th level, the Magister may cast the Shield spell twice per day without expending a spell slot. The Magister must finish a long rest before doing so again.

Beginning at 11th level, the Magister may learn 2 spells from another school’s spell list. These spells must be of a level the Magister can cast.

Beginning at 14th level, the Magister has two more spell slots.
