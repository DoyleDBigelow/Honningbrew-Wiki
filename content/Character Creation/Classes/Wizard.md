Lore Description:
Dev Description: A traditional glass cannon powerhouse of magic, prefers the backline.
Hit Die:
Primary Attributes:
Saving Throws:
Armor Proficiencies:
...
- (a) a component pouch or (b) a staff enchanted with one cantrip
...
Copying a Spell into the Book. When you find a spell of 1st level or higher, you can add it to your spellbook if it is of a level for which you have spell slots and if you can spare the time to decipher and copy it, no matter your specialization.
